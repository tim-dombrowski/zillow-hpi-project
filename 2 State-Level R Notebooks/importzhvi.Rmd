...
To summarize the raw data, let's output the dimensions of the data frame and the first few rows of the data frame. In this table, the 51 rows correspond with the 50 states + DC. Then the first five columns identify the geographical region, and the remaining columns are the monthly ZHVI values.
...
* RegionName: Name of the region
  * *State names for this table.*
* RegionType: Type of region
  * *All are states in this table.*
